<form action="<?= base_url ?>estudiante/save_p" method="POST" class="form-signin">
<?php if (isset($_SESSION['estudiante_p']) && $_SESSION['estudiante_p'] == 'success') : ?>
  ...
  <?php elseif (isset($_SESSION['estudiante_p']) && $_SESSION['estudiante_p'] != 'success') : ?>
    <div class="alert alert-danger" role="alert">
      <strong>Error!, al Inscribirte con Estos Datos o Los Datos Cedula o Email ya existen..</strong>
    <?php endif; ?>
    </div>
    <?php Utils::delete_session('estudiante_p') ?>    
