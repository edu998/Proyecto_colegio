<section id="portfolio">
        <div class="container-fluid">
            <div class="content-center">
                ...
                <p>Para demostrarte la gran calidad en nuestras método de enseñanza, puedes inscribirte e ingresar a nuestras clases gratuitas</p>
            </div>
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="text-center mt-4">
                <p class="">Estás listo para que tú, tu hijo o tus familires, aprendan lo mejor de lo mejor?</p>
    ...
    <section id="team" class="bgLightGrey">
        <div class="container">
            <div class="content-center">
                ...
                <p>Nuestros profesores están más que calificados para brindar un área de aprendizaje muy agradable y con una psicología orientada a nuestros alumnos.</p>
            </div>
            <div class="row">
                <div class="col-md-4">
    ...
    <section id="pricing" class="divider">
        <div class="container">
            <div class="content-center">
                ...
                <p>En el nivel básico nos enfocamos en la educación de los más pequeños de la casa, con los nivles desde primer a sexto grado, y en el bachillerato nos enfocamos en la educación de adolescentes desde primer año hasta sexto año.</p>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="pricing-container">
                        <div class="plans plan-light">
                            ...
                            <a href="formulario.html" class="btn btn-primary full-width mt-4">Inscríbete ahora</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
    ...
    <section id="testimonial" class="divider">
        <div class="container">
            <div class="content-center">
                ...
                <p>Podemos apreciar el gran agrado que sienten los representantes de nuestros alumnos, que nos llena de orgullo.</p>
            </div>
